...
if select == "HOME":
    ...
    with col2:
        st.image(Image.open(r"E:\Guvi Projects\PhonePe Project\Images\phonepe_logo.png"))

    col1, col2, col3 = st.columns(3)
    with col1:
        st.image(Image.open(r"E:\Guvi Projects\PhonePe Project\Images\col1.jpg"))
    with col2:
        st.video(r"E:\Guvi Projects\PhonePe Project\Images\pulse-video.mp4")
    with col3:
        st.image(Image.open(r"E:\Guvi Projects\PhonePe Project\Images\col3.jpg"))
...
#INSIGHTS TAB
    ...
    col1, col2 = st.columns(2)
    with col1:
        st.image(Image.open(r"E:\Guvi Projects\PhonePe Project\Images\aggregated.jpg"))
    with col2:
    ...
    col3, col4 = st.columns(2)
    with col3:
        st.image(Image.open(r"E:\Guvi Projects\PhonePe Project\Images\map.jpg"))
    with col4:
    ...
    col5, col6 = st.columns(2)
    with col5:
        st.image(Image.open(r"E:\Guvi Projects\PhonePe Project\Images\top.jpg"))
    with col6:
        st.subheader("3️⃣ :violet[Top]")
        st.subheader("Totals of top States / Districts / Postal Codes")    
    st.write("---")
    st.image(Image.open(r"E:\Guvi Projects\PhonePe Project\Images\last.jpg"))